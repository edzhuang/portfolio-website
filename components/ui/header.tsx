...
export function Header() {
  ...
  return (
    <div className="fixed z-50 top-4 inset-x-0 md:top-6 transition-[top] duration-300 ease-in-out px-4">
      <header
        className={clsx(
          "transition-[border-radius,height] overflow-hidden container flex flex-col py-2 bg-muted/70 backdrop-blur-md border",
